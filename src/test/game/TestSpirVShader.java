...
public class TestSpirVShader extends GameBase {

	public TestSpirVShader() {
		TICKS_PER_SEC = 20;
	}
	public static void main(String[] args) {
        GameContext.setSideAndPath(Side.CLIENT, "../Game/");
		GameContext.earlyInit();
		new TestSpirVShader().startGame();
	}

	private Shader shaderSpirV;
	int a = 0;
...
//		System.out.println();
	...
	private void loadShader() {
    	try {
        	...
        	this.shaderSpirV.setProgramUniform1i("texColor", 0);
